...
function Signup() {
  ...
  const handleSubmit = (event) => {
    ...
    if (Object.keys(validationErrors).length > 0) {
      ...
      const firstInvalidField = form.elements.namedItem(Object.keys(validationErrors)[0]);
  ...
  const handleFieldChange = (event) => {
    ...
    setErrors((currentErrors) => {
      if (!currentErrors[name] && !(name === 'password' && currentErrors.passwordConfirm)) {
          ...
          <Form onSubmit={handleSubmit} onChange={handleFieldChange} noValidate>
            ...
            <FieldGrid>
              <Field>
                ...
                />
                <ErrorText id="signup-user-id-error" role="alert" $visible={Boolean(errors.userId)}>
              ...
              <Field>
                ...
                />
                <ErrorText id="signup-name-error" role="alert" $visible={Boolean(errors.name)}>
              ...
              <Field>
                ...
                />
                <ErrorText id="signup-email-error" role="alert" $visible={Boolean(errors.email)}>
              ...
              <Field>
                ...
                />
                <ErrorText id="signup-phone-error" role="alert" $visible={Boolean(errors.phone)}>
              ...
              <Field>
                ...
                >
                  <option value="production-line-01">생산운영팀 · LINE-01</option>
                  <option value="production-line-02">생산운영팀 · LINE-02</option>
              ...
              <Field>
                ...
                >
                  <option value="production-record">작업지시 확인 및 생산실적 처리</option>
                  <option value="quality-history">품질 검사 및 품질이력 조회</option>
                  <option value="equipment-alarm">설비 상태 및 알람 모니터링</option>
                  <option value="master-user-management">기준정보 및 사용자 관리</option>
      ...
      {isModalOpen && (
        <ModalBackdrop role="presentation">
          <ModalCard role="dialog" aria-modal="true" aria-labelledby="signup-modal-title">
            <button type="button" onClick={handleSignupComplete} aria-label="로그인으로 이동">
              <FiX aria-hidden="true" />
            </button>
            <FiCheckCircle aria-hidden="true" />
            <h2 id="signup-modal-title">회원가입 신청 완료</h2>
            <p>
              회원가입 신청이 완료되었습니다. 로그인 화면으로 이동해주세요.
            </p>
            <ModalFooter>
